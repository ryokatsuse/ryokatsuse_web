...
[GDG DevFest Tokyo](https://tokyo.gdgjapan.org/devfest2019/)

GDG DevFest Tokyo 2019に行ってきたのでメモしたことをそのまま乗せる。
...
### リアルワールド志向のパフォーマンス
jsゴリゴリなサイトが増えてパフォーマンスが悪くなった。
色々な計測方法が研究されているが指標がマシンのスペックになりがち。
